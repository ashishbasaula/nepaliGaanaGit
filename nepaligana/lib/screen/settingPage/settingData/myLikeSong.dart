...
class likeSongs extends StatefulWidget {
  @override
  _likeSongsState createState() => _likeSongsState();
}

class _likeSongsState extends State<likeSongs> {
  String userid;
            ...
            Container(
              ...
              child: StreamBuilder(
                stream:searchBarController.text==""? FirebaseFirestore.instance
                    .collection("userProfile/" + userid + "/MyLikeVideo")
                    .snapshots():FirebaseFirestore.instance
                    .collection("userProfile/" + userid + "/MyLikeVideo").where("title",isEqualTo: searchBarController.text)
                    .snapshots(),
                    ...
                    return ListView(
                      children: snapshot.data.docs.map((document) {
                        return GestureDetector(
                          onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>singleAudioPlayer("userProfile/"+userid+"/MyLikeVideo",document.id)));
                          },
                                                  child: Card(
                            elevation: 0,
                            child: Container(
