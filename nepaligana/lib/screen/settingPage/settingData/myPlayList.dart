            ...
            Container(
              ...
              child: StreamBuilder(
                stream:searchBarController.text==""? FirebaseFirestore.instance
                    .collection("userProfile/" + userid + "/MyPlayList")
                    .snapshots():FirebaseFirestore.instance
                    .collection("userProfile/" + userid + "/MyPlayList").where("title",isEqualTo: searchBarController.text)
                    .snapshots(),
                    ...
                    return ListView(
                      children: snapshot.data.docs.map((document) {
                        return GestureDetector(
                          onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>singleAudioPlayer("userProfile/"+userid+"/MyPlayList",document.id)));
                          },
                                                  child: Card(
                            elevation: 0,
                            child: Container(
