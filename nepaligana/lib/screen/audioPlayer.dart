...
class audioPlayerPage extends StatefulWidget {
  String audioUrl;
  audioPlayerPage(this.audioUrl);
  @override
  _audioPlayerPageState createState() => _audioPlayerPageState(audioUrl);
}
...
class _audioPlayerPageState extends State<audioPlayerPage>
  ...
  String audioUrl;
  _audioPlayerPageState(this.audioUrl);
  var userid;
  int playerIndex = 0;
  ...
  void getdata() async {
    await FirebaseFirestore.instance.collection(audioUrl).get().then((value) {
      setState(() {
        _playlist = ConcatenatingAudioSource(children: [
          //
          for (var i = 0; i < value.docs.length; i++)
            AudioSource.uri(
              Uri.parse(value.docs[i].data()['MusicUrl'] != null
                  ? value.docs[i].data()['MusicUrl']
              ...
              tag: AudioMetadata(
                downloadLink: value.docs[i].data()['MusicUrl'] != null
                    ? value.docs[i].data()['MusicUrl']
                    : "https://firebasestorage.googleapis.com/v0/b/brhssscl.appspot.com/o/adminProfile%2Fgallery%2F2021-03-30%2011%3A03%3A29.121994?alt=media&token=3cd75657-bbdd-4e81-a23c-bdc5f55143c1",
                album: value.docs[i].data()['album'] != null
                    ? value.docs[i].data()['album']
                    : "This is Album",
                title: value.docs[i].data()['title'] != null
                    ? value.docs[i].data()['title']
                    : "Title",
                artwork: value.docs[i].data()['imageUrl'] != null
                    ? value.docs[i].data()['imageUrl']
